...
namespace YusaTosun.AdvertisementApp.DataAccess.Migrations
{
    public partial class initCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvidedServiceses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisementUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvertisementUser_Advertisements_AdvertisementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementUser_AdvertisementId",
